            ...
            >
              <div>
                ...
                {registeredProducts.length === 0 ? (
                  <div className="p-3 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-xl text-amber-800 dark:text-amber-300 text-xs font-medium">
                    Nenhum produto cadastrado no catálogo. Por favor, cadastre
                    produtos nas{" "}
                    <strong>Configurações &gt; Catálogo de Produtos</strong>{" "}
                    antes de adicionar itens à lista de compras.
                  </div>
                ) : (
                  <div className="relative">
                    <div className="relative z-20">
                      <input
                        ...
                        placeholder="Digite para buscar (Ex: cebola, cebolinha)..."
                          ...
                          {filteredSuggestions.length === 0 ? (
                            <div className="p-4 text-sm text-slate-500 dark:text-slate-400 text-center">
                              ...
                              <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                                Cadastre o produto no catálogo em Configurações
                                para usá-lo.
                              </p>
                            </div>
                          ) : (
